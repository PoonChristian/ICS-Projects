...
public:
    ...
    void swapCharacters(std::vector<std::string>& suggestions,
                        const std::string& word) const;

    void insertAlphabet(std::vector<std::string>& suggestions,
                        const std::string& word) const;

    void deleteCharacters(std::vector<std::string>& suggestions,
                            const std::string& word) const;

    void replaceWithAlphabet(std::vector<std::string>& suggestions,
                            const std::string& word) const;

    void splitWord(std::vector<std::string>& suggestions,
                    const std::string& word) const;
